      ...
      <div className="container mx-auto px-4 ">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-4 md:mb-0">
            <p className="text-sm">
              &copy; Yahye Gedi {currentYear}. All rights reserved.
            </p>
          </div>
          ...
          <div className="flex space-x-4">
            <a 
              href="https://github.com/YahyeGedi?tab=repositories" 
              target="_blank" 
            ...
            <a 
              href="https://www.linkedin.com/in/yahyegedi/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-800 hover:text-gray-900 transition-colors duration-300"
              aria-label="LinkedIn"
            ...
            <a 
              href="https://mail.google.com/mail/u/0/#inbox?compose=VpCqJQwTKzmvKplrgVVCsQrGzNVtzdXSGQsVnxWTmKqlXVwxXlgCpTsJSwkfQbCpcJxWrFq" 
              className="text-gray-800 hover:text-gray-900 transition-colors duration-300"
              aria-label="Email"
            >
              <FaEnvelope size={20} />
